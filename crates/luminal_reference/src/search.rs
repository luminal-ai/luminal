...
pub fn bucketed_search_implementations(
    ...
    let bindings = &crate::bindings::ReferenceBindings;
    let assembled_program = crate::assembled_program();
    ...
    for combo in combos {
        ...
        let outcome = search_implementations_with_ops(&serialized, &program, &data, options, None)?;
