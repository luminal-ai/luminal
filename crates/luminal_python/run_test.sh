...
uv run pytest tests/test_hlir_ops.py tests/test_unary.py tests/test_bitwise.py tests/test_dtype_boundary.py tests/test_torch_dtype_parity.py tests/test_upsample.py -v
