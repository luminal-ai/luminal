...
// INT8 operations - matching the int_8.cu kernel file
fn int_8(x: GraphTensor) -> GraphTensor {
    // Simple pass-through for kernel testing - matches int_8.cu naming
    x
}

// INT8 tests - matching int_8.cu and common_header.cu file names
