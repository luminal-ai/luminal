//! Lifetime-based arena packing. The issue order respects data and anti-dependencies.
//! Uploads and readbacks extend lifetimes through their actual transfer points.
